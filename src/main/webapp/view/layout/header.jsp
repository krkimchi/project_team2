...
<style>
    ...
    .navbar-brand {
        margin-right: 20px;  /* Khoảng cách giữa logo và các menu items */
        font-weight: bold;
        font-size: 1.2em;
    }
    ...
    .navbar-nav {
        display: flex;
        flex-direction: row; /* Đảm bảo các mục trong navbar được căn ngang */
        justify-content: flex-start; /* Căn các mục sang bên trái */
        margin-left: 20px; /* Đẩy các menu items sang trái */
    }

    .navbar-nav .nav-item {
        margin-right: 20px;  /* Khoảng cách giữa các menu items */
    }

    .navbar-nav .nav-item:last-child {
        margin-right: 0;  /* Loại bỏ khoảng cách cho mục cuối */
    }
    ...
    .navbar-nav .nav-link {
        ...
        padding: 10px 20px;
        text-align: left; /* Căn các chữ trong nav-item sang trái */
    }

    .navbar-nav .nav-link:hover {
        color: #689ff2 !important;
        background-color: #444;  /* Thêm hiệu ứng hover */
    }
...
<header class="bg-dark text-white p-3">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand">Hệ thống Đặt Món Ăn</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/customer?action=list_restaurant">List Restaurant</a>
                </li>
            </ul>
        </div>
        <form action="/customer" method="get" class="d-flex justify-content-end align-items-center">
            ...
            <button class="btn btn-primary btn-sm ml-2"
                    style="height: 38px; vertical-align: middle; line-height: 1.5;">Tìm kiếm
            </button>
        </form>
    </nav>
</header>