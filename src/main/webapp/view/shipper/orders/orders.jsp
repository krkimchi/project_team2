            ...
            <table>
                ...
                <c:forEach var="order" items="${ordersList}">
                    <tr>
                        ...
                        <td><c:out value="${order.restaurantName}"/></td>
                        <td><c:out value="${order.dishesWithQuantity}"/></td>
                        <td><c:out value="${order.deliveryPrice}"/></td>
                        <td><a href="/shipper?action=delivery_detail&id=${order.orderId}">View detail</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
